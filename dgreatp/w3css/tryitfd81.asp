...
<!-- Mirrored from www.w3schools.com/w3css/tryit.asp?filename=tryw3css_buttons_bar by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Sep 2016 16:07:34 GMT -->
<head>
...
<h2>Button Bar</h2>
<p>The w3-btn-bar class is similar to "w3-btn-group", except that the buttons inherit the background-color of their container and get a grey background-color on hover, instead of shadows:</p>

<p>Button bar examples:</p>
<div class="w3-btn-bar w3-green">
...
<p>Button group examples:</p>
<div class="w3-btn-group w3-green">
  <button class="w3-btn">Button</button>
  <button class="w3-btn">Button</button>
  <button class="w3-btn">Button</button>
</div>
...
<div class="w3-btn-group w3-border w3-show-inline-block">
  <button class="w3-btn w3-white">Button</button>
  <button class="w3-btn w3-white">Button</button>
  <button class="w3-btn w3-white">Button</button>
</div>
