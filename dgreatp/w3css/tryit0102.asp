...
<!-- Mirrored from www.w3schools.com/w3css/tryit.asp?filename=tryw3css_sidenav_size by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Sep 2016 16:08:31 GMT -->
<head>
...
<nav class="w3-sidenav w3-light-grey w3-large" style="width:30%">
  ...
  <a href="#">Link 4</a>
  <br>
  <a class="w3-padding-16" href="#">Padded</a>
  <a class="w3-padding-24" href="#">Padded</a>
  <a class="w3-padding-32" href="#">Padded</a>
</nav>

<div style="margin-left:30%">

<div class="w3-container">
  <p>Use any of the w3-small, w3-large, w3-xlarge, w3-xxlarge classes to change the size of the side navigation links. This will change their font-size.</p>
  <p>If you want to more padding, add any of the w3-padding classes to each link.</p>
</div>
