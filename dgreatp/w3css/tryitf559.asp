...
<!-- Mirrored from www.w3schools.com/w3css/tryit.asp?filename=tryw3css_navbar_border by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Sep 2016 16:08:29 GMT -->
<head>
...
<ul class="w3-navbar w3-border w3-light-grey">
  <li><a class="w3-border-right" href="#">Home</a></li>
  <li><a class="w3-border-right" href="#">Link 1</a></li>
  <li><a class="w3-border-right" href="#">Link 2</a></li>
  <li><a class="w3-border-right" href="#">Link 3</a></li>
</ul>
