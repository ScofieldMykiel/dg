...
<!-- Mirrored from www.w3schools.com/w3css/tryit.asp?filename=tryw3css_images_opacity_any by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Sep 2016 16:07:40 GMT -->
<head>
...
<p>The w3-opacity class makes images transparent.</p>
<p>The default opacity (0.6) can be changed to any value between 0 and 1.</p>

<img src="img_forest.jpg" alt="Forest" class="w3-opacity" style="width:50%">
<br>
<img src="img_forest.jpg" alt="Forest" class="w3-opacity" style="width:50%;opacity:0.2">
<br>
<img src="img_forest.jpg" alt="Forest" class="w3-opacity" style="width:50%;opacity:0.3">
<br>
<img src="img_forest.jpg" alt="Forest" class="w3-opacity" style="width:50%;opacity:0.4">
<br>
<img src="img_forest.jpg" alt="Forest" class="w3-opacity" style="width:50%;opacity:0.5">
<br>
<img src="img_forest.jpg" alt="Forest" class="w3-opacity" style="width:50%;opacity:0.7">
<br>
<img src="img_forest.jpg" alt="Forest" class="w3-opacity" style="width:50%;opacity:0.8">
