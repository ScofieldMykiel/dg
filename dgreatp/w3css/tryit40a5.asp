...
<!-- Mirrored from www.w3schools.com/w3css/tryit.asp?filename=tryw3css_navbar_dropdown2 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Sep 2016 16:08:30 GMT -->
<head>
...
<p><strong>Note:</strong> When the dropdown menu is "open", the dropdown link gets a grey background color to indicate that it is active. To override this, add a w3-hover-color class to both the "dropdown" li and a:</p>
