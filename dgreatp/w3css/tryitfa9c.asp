...
<!-- Mirrored from www.w3schools.com/w3css/tryit.asp?filename=tryw3css_lists_padding by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Sep 2016 16:07:38 GMT -->
<head>
...
<h2>Padded List</h2>
<p>Use any of the w3-padding classes to increase or decrease the padding of each list item:</p>

<p>4px padding:
<ul class="w3-ul w3-border" style="width:50%">
  <li class="w3-padding-4">Jill</li>
  <li class="w3-padding-4">Eve</li>
  <li class="w3-padding-4">Adam</li>
</ul>

<p>8px padding:</p>
<ul class="w3-ul w3-border" style="width:50%">
  <li class="w3-padding-8">Jill</li>
  <li class="w3-padding-8">Eve</li>
  <li class="w3-padding-8">Adam</li>
</ul>
...
<p>32px padding:</p>
<ul class="w3-ul w3-border" style="width:50%">
  <li class="w3-padding-32">Jill</li>
  <li class="w3-padding-32">Eve</li>
  <li class="w3-padding-32">Adam</li>
</ul>
