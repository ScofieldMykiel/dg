...
<!-- Mirrored from www.w3schools.com/w3css/tryit.asp?filename=tryw3css_buttons_hover_colors by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Sep 2016 16:07:33 GMT -->
<head>
...
<p><button class="w3-btn w3-hover-red">Red</button></p>
<p><button class="w3-btn w3-hover-pink">Pink</button></p>
<p><button class="w3-btn w3-hover-purple">Purple</button></p>
<p><button class="w3-btn w3-hover-deep-purple">Deep Purple</button></p>
<p><button class="w3-btn w3-hover-indigo">Indigo</button></p>
<p><button class="w3-btn w3-hover-blue">Blue</button></p>
<p><button class="w3-btn w3-hover-light-blue">Light Blue</button></p>
<p><button class="w3-btn w3-hover-cyan">Cyan</button></p>
<p><button class="w3-btn w3-hover-aqua">Aqua</button></p>
<p><button class="w3-btn w3-hover-teal">Teal</button></p>
<p><button class="w3-btn w3-hover-green">Green</button></p>
<p><button class="w3-btn w3-hover-light-green">Light Green</button></p>
<p><button class="w3-btn w3-hover-lime">Lime</button></p>
<p><button class="w3-btn w3-hover-sand">Sand</button></p>
<p><button class="w3-btn w3-hover-khaki">Khaki</button></p>
<p><button class="w3-btn w3-hover-yellow">Yellow</button></p>
<p><button class="w3-btn w3-hover-amber">Amber</button></p>
<p><button class="w3-btn w3-hover-orange">Orange</button></p>
<p><button class="w3-btn w3-hover-deep-orange">Deep Orange</button></p>
<p><button class="w3-btn w3-hover-brown">Brown</button></p>
<p><button class="w3-btn w3-hover-blue-grey">Blue Grey</button></p>
<p><button class="w3-btn w3-hover-light-grey">Light Grey</button></p>
<p><button class="w3-btn w3-hover-grey">Grey</button></p>
<p><button class="w3-btn w3-hover-dark-grey">Dark Grey</button></p>
<p><button class="w3-btn w3-hover-black">Black</button></p>
