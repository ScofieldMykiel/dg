...
<!-- Mirrored from www.w3schools.com/w3css/tryit.asp?filename=tryw3css_progressbar_round by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Sep 2016 16:08:34 GMT -->
<head>
...
<p>Use any of the <strong>w3-round</strong> classes to add rounded corners to your progress bars:</p>

<div class="w3-progress-container w3-round">
  <div class="w3-progressbar w3-round" style="width:25%"></div>
</div><br>

<div class="w3-progress-container w3-round-medium">
  <div class="w3-progressbar w3-round-medium" style="width:25%"></div>
</div><br>

<div class="w3-progress-container w3-round-large">
  <div class="w3-progressbar w3-round-large" style="width:25%"></div>
</div><br>
