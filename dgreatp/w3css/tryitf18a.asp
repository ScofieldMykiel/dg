...
<!-- Mirrored from www.w3schools.com/w3css/tryit.asp?filename=tryw3css_sidenav_hover by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Sep 2016 16:08:31 GMT -->
<head>
...
<nav class="w3-sidenav w3-light-grey" style="width:25%">
  <a href="#">Default</a>
  <a class="w3-hover-green" href="#">Link 1</a>
  <a class="w3-hover-black" href="#">Link 2</a>
  <a class="w3-green w3-hover-white" href="#">Link 3</a>
  <a class="w3-hover-blue" href="#">Link 4</a>
  <a class="w3-hover-red" href="#">Link 5</a>
  <a class="w3-hover-purple" href="#">Link 6</a>
  <a class="w3-hover-indigo" href="#">Link 7</a>
  <a class="w3-hover-grey" href="#">Link 8</a>
</nav>
