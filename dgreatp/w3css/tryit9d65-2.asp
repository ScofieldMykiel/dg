...
<!-- Mirrored from www.w3schools.com/w3css/tryit.asp?filename=tryw3css_navbar_sizes2 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Sep 2016 16:08:30 GMT -->
<head>
...
<p>Add the w3-padding-classes to change the padding of each link inside the navbar.</p>
...
<p>w3-padding-24:</p>
<ul class="w3-navbar w3-green">
  <li><a class="w3-padding-24" href="#">Home</a></li>
  <li><a class="w3-padding-24" href="#">Link 1</a></li>
  <li><a class="w3-padding-24" href="#">Link 2</a></li>
</ul>

<p>w3-padding-32:</p>
<ul class="w3-navbar w3-green">
  <li><a class="w3-padding-32" href="#">Home</a></li>
  <li><a class="w3-padding-32" href="#">Link 1</a></li>
  <li><a class="w3-padding-32" href="#">Link 2</a></li>
</ul>

<p><strong>Note:</strong> You can also add padding to the navbar, instead of each link. However, if you do this, note that the links do not get full padding on hover:</p>
<ul class="w3-navbar w3-green w3-padding-16">
  <li><a href="#">Home</a></li>
  <li><a href="#">Link 1</a></li>
  <li><a href="#">Link 2</a></li>
</ul>
