...
<!-- Mirrored from www.w3schools.com/w3css/tryit.asp?filename=tryw3css_navbar_active by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Sep 2016 16:08:29 GMT -->
<head>
...
<p>Add a w3-color class, or the w3-text-color class to the current link to let the user know which page he/she is on:</p>
...
<ul class="w3-navbar w3-border w3-light-grey">
  <li><a class="w3-text-teal" href="#">Home</a></li>
  <li><a href="#">Link 1</a></li>
  <li><a href="#">Link 2</a></li>
  <li><a href="#">Link 3</a></li>
</ul>
