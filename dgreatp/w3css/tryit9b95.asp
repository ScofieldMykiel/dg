...
<!-- Mirrored from www.w3schools.com/w3css/tryit.asp?filename=tryw3css_examples_ads3 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Sep 2016 16:15:47 GMT -->
<head>
...
<div class="w3-container w3-deep-purple w3-large w3-padding-16" style="margin-left:10%">
  <p>Take your class to a different and exiting classrom in <span class="w3-xlarge">DEADLINE</span>.</p>
</div>

<div style="width:50%">
  <div class="w3-container w3-blue w3-large w3-padding-16">
  <p><span class="w3-xlarge">DEADLINE</span> is a free offer to shools, teachers and students from 14 years an up.</p>
  </div>
  <div class="w3-display-container">
