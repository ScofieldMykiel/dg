...
<!-- Mirrored from www.w3schools.com/w3css/tryit.asp?filename=tryw3css_sidenav_border2 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Sep 2016 16:08:31 GMT -->
<head>
...
<nav class="w3-sidenav w3-light-grey w3-border" style="width:25%">
  ...
  <a class="w3-border-bottom" href="#">Link 3</a>
  <a class="w3-border-bottom" href="#">Link 4</a>
  <a class="w3-border-bottom" href="#">Link 5</a>
</nav>
