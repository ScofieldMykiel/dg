...
<!-- Mirrored from www.w3schools.com/w3css/tryit.asp?filename=tryw3css_slideshow_imgdots by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Sep 2016 16:08:35 GMT -->
<head>
...
<div class="w3-container">
  ...
  <p>An example of using images to indicate how many slides there are in the slideshow, and which image the user is currently viewing (red border).</p>
</div>
...
<div class="w3-content" style="max-width:1200px">
  ...
  <div class="w3-row-padding w3-section">
    <div class="w3-col s4">
      <img class="demo w3-border w3-hover-shadow" src="img_nature_wide.jpg" style="width:100%" onclick="currentDiv(1)">
    </div>
    <div class="w3-col s4">
      <img class="demo w3-border w3-hover-shadow" src="img_fjords_wide.jpg" style="width:100%" onclick="currentDiv(2)">
    </div>
    <div class="w3-col s4">
      <img class="demo w3-border w3-hover-shadow" src="img_mountains_wide.jpg" style="width:100%" onclick="currentDiv(3)">
    </div>
  </div>
</div>
