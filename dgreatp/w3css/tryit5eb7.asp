...
<!-- Mirrored from www.w3schools.com/w3css/tryit.asp?filename=tryw3css_buttons_leftright by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Sep 2016 16:15:42 GMT -->
<head>
...
<p>Used to create "next/previous" buttons:</p>

<div class="w3-clear">
  <button class="w3-btn w3-left w3-light-grey">&amp;laquo; Previous</button>
  <button class="w3-btn w3-right w3-green">Next &amp;raquo;</button>
</div>
