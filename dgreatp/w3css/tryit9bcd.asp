...
<!-- Mirrored from www.w3schools.com/w3css/tryit.asp?filename=tryw3css_display_image by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Sep 2016 16:07:32 GMT -->
<head>
...
<div class="w3-display-container w3-text-white">
  ...
  <div class="w3-padding w3-display-topleft"><p>Top Left</p></div>
  <div class="w3-padding w3-display-topright"><p>Top Right</p></div>
  <div class="w3-padding w3-display-bottomleft"><p>Bottom Left</p></div>
  <div class="w3-padding w3-display-bottomright"><p>Bottom Right</p></div>
  <div class="w3-padding w3-display-topmiddle"><p>Top Mid</p></div>
  <div class="w3-padding w3-display-middle w3-xxlarge">Middle</div>
  <div class="w3-padding w3-display-bottommiddle"><p>Bottom Mid</p></div>
</div>
