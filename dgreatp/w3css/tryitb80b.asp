...
<!-- Mirrored from www.w3schools.com/w3css/tryit.asp?filename=tryw3css_modal_fade by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Sep 2016 16:08:36 GMT -->
<head>
...
<button onclick="document.getElementById('id01').style.display='block'" class="w3-btn">Fade In Modal</button>
