...
<!-- Mirrored from www.w3schools.com/w3css/tryit.asp?filename=tryw3css_filters_dropdown by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Sep 2016 16:08:39 GMT -->
<head>
...
<div class="w3-dropdown-click">
  <button class="w3-btn w3-green" onclick="dropFunction()">Dropdown</button>
  <div class="w3-dropdown-content w3-card-2 w3-light-grey" id="myDIV">
