...
<!-- Mirrored from www.w3schools.com/w3css/tryit.asp?filename=tryw3css_grid_rest&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Sep 2016 16:15:42 GMT -->
<head>
...
<h2>Using w3-rest</h2>
<p>The w3-rest class will use what's left of the grid column.</p>
</div>
...
<div class="w3-row">
  ...
  <div class="w3-half">
    <div class="w3-row">
      <div class="w3-col w3-container w3-blue" style="width:20%"><p>80px</p></div>
      <div class="w3-rest w3-container w3-green"><p>w3-rest</p></div>
    </div>
  </div>
