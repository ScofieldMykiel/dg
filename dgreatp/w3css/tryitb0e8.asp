...
<!-- Mirrored from www.w3schools.com/w3css/tryit.asp?filename=tryw3css_images_border by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Sep 2016 16:07:39 GMT -->
<head>
...
<p>The w3-border class adds borders around the image.</p>
<p><strong>Tip:</strong> Use any of the w3-padding classes if you want padding inside the borders:</p>

<img src="img_fjords.jpg" class="w3-border w3-padding w3-padding-16" alt="Norway" style="width:50%">
