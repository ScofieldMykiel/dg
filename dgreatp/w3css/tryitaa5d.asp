...
<!-- Mirrored from www.w3schools.com/w3css/tryit.asp?filename=tryw3css_lists_hoverable2 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Sep 2016 16:07:38 GMT -->
<head>
...
<div class="w3-container">
  ...
  <ul class="w3-ul">
    ...
    <li class="w3-hover-blue">Adam</li>
    <li class="w3-hover-black">Bo</li>
    <li class="w3-hover-orange">Anja</li>
  </ul>
</div>
