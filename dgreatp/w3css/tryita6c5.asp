...
<!-- Mirrored from www.w3schools.com/w3css/tryit.asp?filename=tryw3css_navbar_sizes by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Sep 2016 16:08:29 GMT -->
<head>
...
<p>Add the w3-small, w3-large, w3-xlarge or w3-xxlarge to change the size of the navigation (will change the font-size of each link).</p>
...
<p>w3-xxlarge:</p>
<ul class="w3-navbar w3-green w3-xxlarge">
  <li><a href="#">Home</a></li>
  <li><a href="#">Link 1</a></li>
  <li><a href="#">Link 2</a></li>
  <li><a href="#">Link 3</a></li>
...
<p>If you want more space between each link, instead of increasing the font-size, you could add the w3-padding-classes to each link:</p>
...
<!-- Mirrored from www.w3schools.com/w3css/tryit.asp?filename=tryw3css_navbar_sizes by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Sep 2016 16:08:30 GMT -->
</html> 
</textarea>
