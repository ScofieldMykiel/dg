...
<!-- Mirrored from www.w3schools.com/w3css/tryit.asp?filename=tryw3css_sidenav_icons by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Sep 2016 16:08:31 GMT -->
<head>
...
<nav class="w3-sidenav w3-black" style="width:70px">
  <a class="w3-padding-16" href="#"><i class="fa fa-home w3-xxlarge"></i></a> 
  <a class="w3-padding-16" href="#"><i class="fa fa-search w3-xxlarge"></i></a> 
  <a class="w3-padding-16" href="#"><i class="fa fa-envelope w3-xxlarge"></i></a> 
  <a class="w3-padding-16" href="#"><i class="fa fa-globe w3-xxlarge"></i></a>
  <a class="w3-padding-16" href="#"><i class="fa fa-trash w3-xxlarge"></i></a> 
</nav>

<div style="margin-left:70px">

<div class="w3-container">
  <p>In this example we use icons instead of text inside the side navigation.</p>
  <p>Note that we have added some padding to each link as well.</p>
</div>
...
<!-- Mirrored from www.w3schools.com/w3css/tryit.asp?filename=tryw3css_sidenav_icons by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Sep 2016 16:08:32 GMT -->
</html> 
</textarea>
