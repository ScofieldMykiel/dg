...
<!-- Mirrored from www.w3schools.com/w3css/tryit.asp?filename=tryw3css_lists by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Sep 2016 16:07:37 GMT -->
<head>
...
<div class="w3-container">
  <h2>Basic List</h2>
  <p>The w3-ul class creates a basic list:</p>
  <ul class="w3-ul">
    <li>Jill</li>
    <li>Eve</li>
    <li>Adam</li>
