...
<!-- Mirrored from www.w3schools.com/w3css/tryit.asp?filename=tryw3css_images_hover by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Sep 2016 16:07:39 GMT -->
<head>
...
<p>The w3-hover-opacity class adds transparency to the image when you move the mouse over it:</p>

<img src="img_fjords.jpg" class="w3-hover-opacity" alt="Norway" style="width:50%">

<p>The w3-hover-opacity-off class rempves transparency from an image when you move the mouse over it:</p>

<img src="img_fjords.jpg" class="w3-opacity w3-hover-opacity-off" alt="Norway" style="width:50%">
