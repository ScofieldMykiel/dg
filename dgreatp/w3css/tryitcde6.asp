...
<!-- Mirrored from www.w3schools.com/w3css/tryit.asp?filename=tryw3css_trends_full_input by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Sep 2016 16:15:44 GMT -->
<head>
...
<img src="img_sailboat.jpg" alt="Boat" class="w3-animate-opacity" style="width:100%;min-height:200px;max-height:400px;">
...
class="w3-btn">Register</button></p>
</div>


<form id="id01" action="http://www.w3schools.com/w3css/form.asp" class="w3-modal w3-pale-yellow">
