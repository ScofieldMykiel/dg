...
<!-- Mirrored from www.w3schools.com/w3css/tryit.asp?filename=tryw3css_sidenav_left_right&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Sep 2016 16:15:43 GMT -->
<head>
...
<header class="w3-container w3-teal">
  <span class="w3-opennav w3-xlarge" onclick="openLeftMenu()">&amp;#9776;</span>
  <span class="w3-opennav w3-xlarge w3-right" onclick="openRightMenu()">&amp;#9776;</span>
  <h1>My Header</h1>
</header>

<div class="w3-container">
  <p>In this example, we demonstrate how to use two side navigations. We have created two "menu" buttons: one to open the sidenav from the left and one to open it from the right.</p>
</div>
