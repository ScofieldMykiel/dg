...
<!-- Mirrored from www.w3schools.com/w3css/tryit.asp?filename=tryw3css_sidenav_right by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Sep 2016 16:15:43 GMT -->
<head>
...
<nav class="w3-sidenav w3-white w3-card-2" style="width:25%;right:0;">
  <br>
  <a href="#">Link</a>
  <a href="#">Link</a>
  <a href="#">Link</a>
...
<div class="w3-container">
  ...
  <p>In this example, we add <strong>right:0</strong> to the w3-sidenav container to place the sidenav to the right.</p>
  <p>Note that you control the size of the sidenav with style="width:value". To change the color, change the w3-color class.</p>
  <p>Make sure to add the margin-right property to the page content, with a value that is equal to the width of the sidenav. If you omit this, the navigation pane will overlay/sit on top of the page content.</p>
</div>
