		...
		<div class="row">
			...
			<div class="col-lg-12 col-md-12 col-sm-12">
				<ul class="breadcrumb">
					...
					<li><i class="fa fa-chevron-left"></i></li>
					<li><a href="course_single.php">Php course</a></li>
				</ul>
			</div>
		</div>
	</div>
			...
			<div class="col-lg-9 col-md-9 col-sm-12">
				<div class="ed_course_single_item">
					...
					<div class="ed_course_single_info">
						<h2>Php Course <span>free</span></h2>
						<div class="ed_rating">
							<div class="row">
							...
							<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
								<div class="course_detail">
									<div class="course_faculty">
										<img src="images/content/about_small.jpg" alt=""> <a href="instructor_dashboard.php">evans sinai</a>
									</div>
								</div>
							</div>
				...
				<div class="ed_time_executor ed_toppadder40">
					<ul>
						<li><a href="#">Lesson</a> <span>estimated time</span></li>
						<li><a href="#" onclick="myFunction()">PHP install</a><span>1Hourse 10 Minuts</span></li>
						<li><a href="#" onclick="myFunction()">PHP Syntax</a> <span>2Hourse 30 Minuts</span></li>
						<li><a href="#" onclick="myFunction()">PHP Variable</a> <span>3Hourse 15 Minuts</span></li>
						<li><a href="#" onclick="myFunction()">PHP Echo/Print</a> <span>1Hourse 30 Minuts</span></li>
						<li><a href="#" onclick="myFunction()">Others</a> <span>2Hourse 45 Minuts</span></li>
					</ul>
				</div>
			</div>
<!--Sidebar Start-->
					...
					<div id="owl-demo3" class="owl-carousel owl-theme">
						<div class="item">
							...
							<div class="ed_mostrecomeded_course_slider ed_most_recomended_data">
								<h4><a href="course_single.php">PHP Course </a><span>free</span></h4>
							</div>
						</div>
						<div class="item">
							<div class="ed_item_img">
							...
							<div class="ed_mostrecomeded_course_slider ed_most_recomended_data">
								<h4><a href="course_single.php">HTML 5 Course</a><span>free</span></h4>
							</div>
						</div>
						<div class="item">
							<div class="ed_item_img">
