...
<div class="ed_newsletter_section" data-stellar-background-ratio="0.5" data-stellar-vertical-offset="-1800">
			...
			<div class="row">
				<div class="col-lg-4 col-md-4 col-sm-12">
					<div class="widget text-widget">
						<p><a href="index.php"><img src="images/footer/F_Logo.png" alt="Footer Logo" /></a></p>
				...
				<div class="col-lg-4 col-md-4 col-sm-12">
					<div class="widget text-widget">
						...
						<p><i class="fa fa-safari"></i>Adeshina Street 5, Fadeyi Lagos, <br/>Nigeria</p>
						<p><i class="fa fa-envelope-o"></i><a href="#">info@dgp.edu.ng</a> <a href="#">public@dgp.edu.ng</a></p>
