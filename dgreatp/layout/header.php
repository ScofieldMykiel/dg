...
<head>
	...
	<title>DGP HTML5 TUTORIAL</title>
		...
		<!--<div class="navbar-collapse collapse" id="navbar-mobile">
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown">
					...
					<div class="dropdown-menu dropdown-content width-1">
						<div class="dropdown-content-heading">
							
							<ul class="icons-list">
								<li><a href="#"><i class="icon-compos"></i></a></li>
							</ul>
						</div>
						...
						<div class="dropdown-content-footer">
							<a href="#" data-popup="toolti" title="All messages"><i class="icon-menu display-block"></i></a>
						</div>
					</div>
				</li>
	...
	<div class="page-header">
		<div class="breadcrumb-line breadcrumb-line-wide">
			<ul class="breadcrumb">
				...
				<li class="active">HTML5 Tutorial</li>
			</ul>
		...
		<!--<div class="page-header-content">
			<div class="page-title">
				<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Home</span> - HTML5 Tutorial <small>Hello, Welcome!</small></h4>
			</div>
					...
					<div class="sidebar-category sidebar-category-visible">
						...
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<!-- Main -->
								<li class="navigation-header"><span>HTML5 Tutorial</span> <i class="icon-menu" title="Main pages"></i></li>
