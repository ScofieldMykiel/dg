...
// gptAdSlots[0] = googletag.defineSlot('/16833175/TryitLeaderboard', [728, 90], 'div-gpt-ad-1428407818244-0').
   ...
   googletag.pubads().setTargeting("content","try" + (function () {
     ...
     folder = folder.replace("index.php", "");
     folder = folder.substr(0, folder.indexOf("index.php"));
     return folder;
   })()
   );
...
<ul class="w3-navbar w3-light-grey" style="border-top:1px solid #f1f1f1;">
  <li class="stack" id="tryhome" style="width:auto !important;float:left;"><a href="default.php" target="_blank" title=" Home" class="topnav-icons fa fa-home" style="font-size:28px;color:#999999;margin-top:-2px" title="Home"></a></li>
