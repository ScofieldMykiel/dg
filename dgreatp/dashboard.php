		...
		<div class="row">
			...
			<div class="col-lg-12 col-md-12 col-sm-12">
				<ul class="breadcrumb">
					...
					<li><a href="dashboard.php">Educo Student</a></li>
				</ul>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
				<div class="ed_sidebar_wrapper">
					...
					<img src="images/content/S01_big.jpg" alt="Dashboard Image" />
					</div>
					<h3>andre house</h3>
									...
									<h2>you have 4 subscribed courses</h2>
										<div class="row">
											<div class="ed_mostrecomeded_course_slider">
												...
												<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 ed_bottompadder20">
													<div class="ed_item_img">
														<img src="images/slider/sec1_s8.jpg" alt="item1" class="img-responsive">
													</div>
													<div class="ed_item_description ed_most_recomended_data">
